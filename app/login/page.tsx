...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-primary-600/10 blur-[100px] rounded-full -z-10" />
            ...
            >
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center ml-1">
                            ...
                            <Link href="#" className="text-xs text-primary-500 hover:text-primary-400 transition-colors">Forgot Password?</Link>
                        </div>
                        <div className="relative group">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full py-4 bg-primary-600 hover:bg-primary-500 disabled:opacity-50 rounded-xl font-bold flex items-center justify-center transition-all shadow-lg hover:shadow-primary-600/30"
                    >
                        {isLoading ? (
                            <motion.div
                                animate={{ rotate: 360 }}
                ...
                <div className="mt-8 pt-8 border-t border-white/5 space-y-4">
                    ...
                    <p className="text-center text-sm text-gray-500">
                        ...
                        <Link href="/register" className="text-primary-500 font-bold hover:underline">Sign up</Link>
                    </p>
                </div>
            </motion.div>
        </div>
